                ...
                <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">       <!-- !!!/img/bg-img/ - custom -->    
                          <img class="img_product" src="<?php if(isset($image)): ?><?php echo e(asset('public/img/bg-img/' . $image)); ?><?php else: ?><?php echo e(asset('public/img/bg-img/nophoto.jpg')); ?><?php endif; ?>" alt="" style="width: 150px; margin-top: 5px;" />
                        ...
                        <!-- 'bg-img/' . - custom -->
                        <input type="hidden" id="image" name="image" value="<?php if(isset($image)): ?><?php echo e('bg-img/' . $image); ?><?php else: ?><?php echo e('bg-img/nophoto.jpg'); ?><?php endif; ?>">
