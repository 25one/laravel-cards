                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="form-group <?php echo e($errors->has('number') ? 'has-error' : ''); ?>">
                            ...
                            <input type="text" class="form-control" id="number" name="number" value="<?php if(isset($card)): ?><?php echo e($card->number); ?><?php elseif(old('number')): ?><?php echo e(old('number')); ?><?php endif; ?>" placeholder="7777 7777 7777 7777" required> 
                            <?php echo $errors->first('number', '<small class="help-block">:message</small>'); ?>

                        </div>
                        <div class="form-group">
                            <label for="type"><?php echo app('translator')->getFromJson('Type Card'); ?> - <?php echo e(count($types)); ?></label>
                        ...
                        <div class="form-group">
                            <label for="user"><?php echo app('translator')->getFromJson('User'); ?> - <?php echo e(count($users)); ?></label>
...
<?php echo $__env->make('back.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel-cards/resources/views/back/cards/template.blade.php ENDPATH**/ ?>