                ...
                <!-- form start -->
                    ...
                    <div class="box-body">
                        <div class="form-group <?php echo e($errors->has('number') ? 'has-error' : ''); ?>">
                            ...
                            <input type="text" class="form-control" id="number" name="number" value="<?php if(isset($card)): ?><?php echo e($card->number); ?><?php elseif(old('number')): ?><?php echo e(old('number')); ?><?php endif; ?>" placeholder="7777 7777 7777 7777"> 
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="card_id" id="card_id">
                               <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <?php if(old('card_id') && old('card_id') == $type->id): ?> 
                                     <?php echo e('selected'); ?>

                                  <?php elseif(isset($card) && $card->card_id == $type->id): ?> 
                                     <?php echo e('selected'); ?> 
                                  <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user_id" id="user_id">
                               <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <?php if(old('user_id') && old('user_id') == $user->id): ?> 
                                     <?php echo e('selected'); ?>

                                  <?php elseif(isset($card) && $card->user_id == $user->id): ?> 
                                     <?php echo e('selected'); ?>                                      
                                  <?php endif; ?>
