     ...
     <aside class="main-sidebar">
        <section class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="header" style="font-size: 15px;">AUTOS</li>  
                <li>
                    <a href="<?php echo e(url('/dashboard')); ?>">
                        <i class="fa fa-folder-o"></i> <span>List of Autos</span>
                    </a>
                </li>
                <?php if (\Illuminate\Support\Facades\Blade::check('admin')): ?>
                <li>
                    <a href="<?php echo e(route('autos.create')); ?>">
                        <i class="fa fa-folder-o"></i> <span>Add new Auto</span>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
...
<?php /**PATH /home/alex/www/laravel-auto-group1-test/resources/views/back/layout.blade.php ENDPATH**/ ?>