                ...
                <!-- form start -->
                     <div class="box-body">
                        <div class="form-group">
                          <img class="img_auto" src="<?php if(isset($image)): ?><?php echo e(asset('public/images/' . $image)); ?><?php elseif(isset($auto)): ?><?php echo e(asset('public/images/' . $auto->image)); ?><?php else: ?><?php echo e(asset('public/images/nophoto.jpg')); ?><?php endif; ?>" alt="" style="width: 250px; margin-top: 5px;" />
                    ...
                    <input type="hidden" id="image" name="image" value="<?php if(isset($image)): ?><?php echo e($image); ?><?php elseif(isset($auto)): ?><?php echo e($auto->image); ?><?php else: ?><?php echo e('nophoto.jpg'); ?><?php endif; ?>">  
                        <div class="form-group">
                            <label for="type"><?php echo app('translator')->getFromJson('Type of Country'); ?></label>
                            <select class="form-control" name="country_id" id="country_id">
                              <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
                                 <option value="<?php echo e($country->id); ?>"
                                 <?php if(isset($auto) && $auto->country_id == $country->id): ?>
                                    <?php echo e('selected'); ?>
...
<?php echo $__env->make('back.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alex/www/laravel-auto-group1-test/resources/views/back/autos/template.blade.php ENDPATH**/ ?>