                ...
                <!-- form start -->
                    <div class="box-body">
                        <div class="form-group">       <!-- !!!/img/bg-img/ - custom -->    
                          <img class="img_product" src="@if(isset($image)){{asset('public/img/bg-img/' . $image)}}@elseif(old('image')){{asset('public/img/' . old('image'))}}@else{{asset('public/img/bg-img/nophoto.jpg')}}@endif" alt="" style="width: 150px; margin-top: 5px;" />
                        ...
                        @yield('form-open')  
                        <!-- 'bg-img/' . - custom -->
                        <input type="hidden" id="image" name="image" value="@if(isset($image)){{'bg-img/' . $image}}@elseif(old('image')){{old('image')}}@else{{'bg-img/nophoto.jpg'}}@endif">
